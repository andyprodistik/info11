...
/**
 * `CustomInfo11Theme`
 * `CustomInfo11Theme based on modern flex design system`
 ...
 * @element custom-info11-theme
 */
class CustomInfo11Theme extends PolarisFlexTheme {
  //styles function
  static get styles() {
    return [
      super.styles,
...
customElements.define(CustomInfo11Theme.tag, CustomInfo11Theme);
export { CustomInfo11Theme };
